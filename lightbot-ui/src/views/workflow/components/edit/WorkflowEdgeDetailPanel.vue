...
.edge-detail-label { font-size: 12px; color: var(--color-mute); }
.edge-detail-value {
  font-size: 13px;
...
.edge-node-name { font-size: 14px; font-weight: 600; color: var(--color-ink); }
.edge-node-type { font-size: 12px; color: var(--color-mute); }
.edge-handle-tag {
  font-size: 11px;
  color: #7c3aed;
